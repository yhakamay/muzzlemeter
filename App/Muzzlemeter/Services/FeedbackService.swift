...
final class FeedbackService {
    ...
    private enum Keys {
        static let limitSound = "muzzlemeter.feedback.limitSound"
        static let limitHaptics = "muzzlemeter.feedback.limitHaptics"
        static let speech = "muzzlemeter.feedback.speech"
        static let speechJoules = "muzzlemeter.feedback.speechJoules"
        static let speechRate = "muzzlemeter.feedback.speechRate"
    }
