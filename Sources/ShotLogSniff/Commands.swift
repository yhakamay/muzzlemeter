...
extension SniffCommand {
    struct Dump: ParsableCommand {
        static let configuration = CommandConfiguration(
            ...
            discussion: """
                例:
                  shotlog-sniff dump --name AC6000BT- --handshake
                  shotlog-sniff dump --name AC6000
                  shotlog-sniff dump --id 1234ABCD-... --log tools/re/captures/shot1.log
                  shotlog-sniff dump --name AC6000 --write ffe1 01a50000 --write ffe1 02
                  shotlog-sniff dump --name AC6000 --interactive --write-type without
